...
This time the classifier greatly predict most of the minority samples in testing set, so the sensitivity is 0.625. In the mean time, the specificity is 0.7664, which means this classifier can also correctly classify most of the majority samples. The improvement of performance is significant!
